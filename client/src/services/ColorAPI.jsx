...
export const getColor = async (id) => {
  try {
    ...
    if (!response.ok) {
      throw new Error(`Error fetching color with ID ${id}: ${response.statusText}`);
    }
    const data = await response.json();
    return data;
  } catch (error) {
...
export const createColor = async (colorData) => {
  try {
    ...
    if (!response.ok) {
      throw new Error(`Error creating color: ${response.statusText}`);
    }
    const data = await response.json();
    return data;
  } catch (error) {
...
export const updateColor = async (id, updatedColorData) => {
  try {
    ...
    if (!response.ok) {
      throw new Error(`Error updating color with ID ${id}: ${response.statusText}`);
    }
    const data = await response.json();
    return data;
  } catch (error) {
...
export const deleteColor = async (id) => {
  try {
    ...
    if (!response.ok) {
      throw new Error(`Error deleting color with ID ${id}: ${response.statusText}`);
    }
    return true;
  } catch (error) {
